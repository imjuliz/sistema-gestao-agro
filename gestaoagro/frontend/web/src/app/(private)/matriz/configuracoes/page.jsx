...
//                 Gerencie as configurações da AgroTech e personalize o comportamento do sistema.
//             </p>
...
//                                                         <Input type="text" defaultValue={''} className="flex-1" />
...
//                                                 </Label>
//                                                 <p className="text-sm text-muted-foreground mb-2">
//                                                     Excluir permanentemente a empresa (Matriz) e todos os dados. A ação não é reversível — proceda com cuidado.
//                                                 </p>
//                                                 <Alert variant="destructive" className="mb-4 max-w-md">
//                                                     <AlertTriangle className="h-4 w-4" />
//                                                     <AlertTitle>Aviso</AlertTitle>
//                                                     <AlertDescription>
//                                                         Para excluir sua conta, visite as configurações de Conta.
//                                                         <a
//                                                             href={''}
...
//                                 <div className="grid gap-4">
//                                     <div>
//                                         <Label className={"pb-3"}>Fonte</Label>
...
//                                         </Select>
//                                         <p className="text-sm text-muted-foreground mt-1">
//                                             Defina a fonte usada no painel.
//                                         </p>
//                                     </div>
...
//                                                 <div className="text-sm mt-2 text-center">Claro</div>
//                                             </button>
...
//                                                 <div className="text-sm mt-2 text-center">Escuro</div>
//                                             </button>
//                                         </div>
//                                     </div>
                            ...
                            <>
                                ...
                                <div className="grid gap-4">
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground mt-1">
                                            Defina o tamanho da fonte de sua preferencia.
                                        </p>
                                    </div>
